...
1. **Initial preparation**:
   ...
   - Prepare data slate with invertebrate recording sheets
   - Ensure measuring tools are accessible
...
:::
::: {.column width="50%" style="padding: 0.5em;"}
<div style="background-color: #D4E6F1; color: black; padding: 0.7em; border-radius: 5px; border-left: 10px solid #3498DB;">
<strong>Filter/Suspension Feeders</strong><br>
Extract particles from water column<br>
<em>Examples: Giant clams, feather stars, fan worms</em>
</div>
:::
::: {.column width="50%" style="padding: 0.5em;"}
...
<em>Examples: COTS, many gastropods, octopus</em>
</div>
:::
::::
