...
::: {.callout-note appearance="simple" title="**Seabed BRUVS Specifications**"}
- **Deployment duration**: Minimum 60 minutes (standard protocol)
- **Camera configuration**: Stereo setup with 80 cm separation, 8° convergence
- **Bait standard**: 1 kg crushed oily fish in perforated canister
- **Depth range**: 5-70+ meters depending on conditions
- **Replication**: Up to 9 deployments per day, 3 rigs per round
:::
...
::: {.callout-important appearance="simple" title="**Slope Assessment**"}
Substrate slope is the most critical factor determining deployment success:
